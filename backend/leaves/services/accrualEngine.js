...
class AccrualEngine {
    ...
    async postMonthlyAccruals(monthNum, year) {
        try {
            ...
            // Idempotency guard: if we already have auto-generated accrual entries for this month/year, skip.
            const existingAccrual = await LeaveRegister.findOne({
                year: Number(year),
            ...
            if (existingAccrual) {
                return {
                    ...results,
                    message: `Accruals already posted for ${monthNum}/${year} – skipping (idempotency guard).`
                };
            }
