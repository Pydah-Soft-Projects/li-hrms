...
router.get('/roster', authorize('super_admin', 'sub_admin', 'hr', 'hod'), preScheduledShiftController.getRoster);
router.post('/roster', authorize('super_admin', 'sub_admin', 'hr', 'hod'), preScheduledShiftController.saveRoster);
