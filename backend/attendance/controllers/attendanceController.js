...
exports.updateOutTime = async (req, res) => {
  try {
    ...
    attendanceRecord.editHistory.push({
      ...
      modifiedAt: new Date(),
      details: `Out time updated manually to ${outTimeDate.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true, timeZone: 'UTC' })}`
    });
...
exports.updateInTime = async (req, res) => {
  try {
    ...
    attendanceRecord.editHistory.push({
      ...
      modifiedByName: req.user.name,
      modifiedAt: new Date(),
      details: `In time updated manually to ${newInTime.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true, timeZone: 'UTC' })}`
    });
