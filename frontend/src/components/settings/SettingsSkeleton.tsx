...
export const SettingsSkeleton = () => {
  return (
    <div className="settings-ledger-scope animate-pulse space-y-4 p-3 sm:space-y-5 sm:p-4">
      <div className="border-b pb-3" style={settingsLedgerBorder}>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="space-y-4">
          <div className={`${settingsCardClass} p-3 sm:p-4`} style={settingsLedgerBorder}>
            <div className="mb-4 h-5 w-40 rounded bg-stone-300 dark:bg-stone-700" />
            <div className="space-y-4">
          ...
          <div className={`${settingsCardClass} p-3 sm:p-4`} style={settingsLedgerBorder}>
            <div className="mb-4 h-5 w-32 rounded bg-stone-300 dark:bg-stone-700" />
            <div className="space-y-4">
        ...
        <div>
          <div className={`${settingsCardClass} p-3 sm:p-4`} style={settingsLedgerBorder}>
            <div className="mb-4 h-5 w-36 rounded bg-stone-300 dark:bg-stone-700" />
            <div className="space-y-4">
...
export const SettingsCardSkeleton = () => {
  return (
    <div
      className={`${settingsCardClass} animate-pulse p-3 sm:p-4`}
