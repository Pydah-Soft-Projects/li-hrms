...
export default function ODReportsTab() {
    ...
    return (
        <div className="space-y-6 max-w-5xl">
            {/* Header Description */}
            <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 dark:bg-emerald-950/20 dark:border-emerald-900/30">
                <div className="flex gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-emerald-700/80 dark:text-emerald-300/80 mt-1 font-medium">
                            ...
                            Track outdoor assignments and official visits across the organization.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="p-5 grid gap-4 md:grid-cols-3">
                    <div className="space-y-1.5">
                        ...
                        <select
                            ...
                            className="w-full h-10 rounded-xl border border-slate-200 bg-slate-50 px-3 text-xs font-bold outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all dark:bg-slate-800 dark:border-slate-700 dark:text-white"
                        >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <select
                            ...
                            className="w-full h-10 rounded-xl border border-slate-200 bg-slate-50 px-3 text-xs font-bold outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all dark:bg-slate-800 dark:border-slate-700 dark:text-white disabled:opacity-50"
                        >
            ...
            <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm dark:bg-slate-900 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-emerald-50 flex items-center justify-center dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-900/30">
                        <Download className="h-6 w-6 text-emerald-600 shadow-sm" />
                    </div>
                    <div>
                        <p className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wider">Ready for Export</p>
                        <p className="text-[11px] text-slate-500 font-medium">Download the comprehensive On-Duty (OD) PDF report now.</p>
                    </div>
                </div>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full md:w-auto flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all shadow-[0_8px_20px_rgba(5,150,105,0.3)] active:scale-95 disabled:opacity-50 disabled:active:scale-100"
                >
                    {loading ? (
                        <>
