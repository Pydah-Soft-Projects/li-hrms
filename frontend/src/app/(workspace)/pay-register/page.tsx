...
import { useState, useEffect, type MouseEvent, useMemo, useRef } from 'react';
...
export default function PayRegisterPage() {
  ...
  /** Highlight grid days that contribute to a clicked monthly total (same idea as attendance contributingDates). */
  ...
  const handleSaveDate = async () => {
    ...
    try {
      ...
      const updatePayload = mergeEditDataLeaveNatureFromTypes(
        ...
        leaveTypes,
        isHalfDayMode
      ) as typeof editData & { isSplit: boolean; isLate?: boolean; isEarlyOut?: boolean };
