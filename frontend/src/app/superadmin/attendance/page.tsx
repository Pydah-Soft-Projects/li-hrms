          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-700 dark:bg-slate-900 scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-600">
              ...
              {(attendanceDetail.rosterFirstHalfNonWorking || attendanceDetail.rosterSecondHalfNonWorking) && (
                <div className="mt-4 rounded-xl border border-rose-200 bg-rose-50/70 p-4 dark:border-rose-800/60 dark:bg-rose-900/20">
              ...
              {attendanceDetail.hasOD && attendanceDetail.odInfo && (
                <ODDetailCard
                  ...
                  data={{
                    ...
                    earlyOutMinutes: attendanceDetail.earlyOutMinutes,
                    earlyOutDeduction: attendanceDetail.earlyOutDeduction,
                  }}
                />
              )}
